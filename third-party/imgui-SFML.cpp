...
void Image(const sf::Texture& texture, const sf::Vector2f& size,
    ...
    ImTextureID textureID =
        convertGLTextureHandleToImTextureID(texture.getNativeHandle());
    ImGui::Image(textureID, {size.x, size.y}, ImVec2(0, 0), ImVec2(1, 1), ImVec4(tintColor.r, tintColor.g, tintColor.b, tintColor.a),
...
void Image(const sf::Texture& texture, const sf::Vector2f& size,
    ...
    ImTextureID textureID =
        convertGLTextureHandleToImTextureID(texture.getNativeHandle());
    ImGui::Image(textureID, {size.x, size.y}, uv0, uv1, ImVec4(tintColor.r,tintColor.g,tintColor.b,tintColor.a), ImVec4(borderColor.r,borderColor.g,borderColor.b,borderColor.a));
}
...
void DrawLine(const sf::Vector2f& a, const sf::Vector2f& b,
    ...
    sf::Vector2f pos = {imVec2.x, imVec2.y};
...
bool imageButtonImpl(const sf::Texture& texture,
    ...
    ImTextureID textureID =
        convertGLTextureHandleToImTextureID(texture.getNativeHandle());
    return ImGui::ImageButton(textureID, {size.x, size.y}, uv0, uv1, framePadding, ImVec4(bgColor.r,bgColor.g,bgColor.b,bgColor.a),
